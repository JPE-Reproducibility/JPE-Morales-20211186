...
%   firm in the tradable sector that hires immigrants but does not
%   export. Driven to zero by bisection inside equilLoop to recover the
%   firm's optimal native domestic share s_d.
%
