...
%   non-exporter in NT, non-exporter in T, and exporter in T -- all with
%   immigrants. These levels are compared against the no-immigrant
%   counterparts in profitsnimm to pick each firm's globally optimal
%   status inside equilLoop.
%
%   Inputs:
%
