...
%   plus N_x draws of psi_x for the rest of the world. In the homogeneous model
%   f_j and f_j_nt are zeroed (no within-sector fixed-cost heterogeneity).
%
%   Input:
%
...
psi_g    = normal_draw(:, 1);
f_j      = 0 * normal_draw(:, 2);       % homogeneous: zero fixed-cost heterogeneity
psi_x    = normal_draw_x(:, 1);
psi_g_nt = normal_draw_nt(:, 1);
f_j_nt   = 0 * normal_draw_nt(:, 2);    % homogeneous: zero fixed-cost heterogeneity
