...
%
%   [D_t, D_nt, Dexp, F_t, F_nt] = GE(...) computes the firm-level demand
%   shifters in T (D_t), NT (D_nt), and the export market (Dexp), and the
%   per-source fixed-cost units F_t and F_nt.
%
%   Inputs:
%
...
%   Outputs:
%
%     D_t, D_nt, Dexp     - firm-level demand shifters.
