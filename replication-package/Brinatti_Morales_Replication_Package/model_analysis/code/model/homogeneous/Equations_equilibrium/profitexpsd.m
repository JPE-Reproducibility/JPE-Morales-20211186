...
%
%   profsd_exp = profitexpsd(sd, ...) returns the derivative of profit
%   with respect to the native domestic share s_d, evaluated firm by firm
%   at sd, for an exporting firm in the tradable sector. 
%
%   Inputs:
%
